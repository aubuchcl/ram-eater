...
TARGET_MEMORY_USAGE = int(TARGET_MEMORY_GB * (1024**3))  # Convert GB to bytes and ensure it's an integer
...
try:
    while True:
        ...
        if current_memory_usage < TARGET_MEMORY_USAGE:
            ...
            allocation_size = int(allocation_size)  # Ensure allocation size is an integer
